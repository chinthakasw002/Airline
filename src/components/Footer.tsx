    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">About Airline</h3>
            <p className="text-sm">Airline is your trusted partner for hassle-free flight bookings. We offer a wide range of options to make your travel dreams come true.</p>
          </div>
          <div>
